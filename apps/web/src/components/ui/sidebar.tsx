...
function SidebarGroupLabel({
	...
	const defaultProps = {
		className: cn(
			"flex h-10 shrink-0 items-center rounded-lg px-2 font-medium text-sidebar-foreground text-xs outline-hidden ring-sidebar-ring transition-[margin,opacity] duration-200 ease-linear focus-visible:ring-2 [&>svg]:size-4 [&>svg]:shrink-0",
...
function SidebarMenuSkeleton({
	...
	return (
		<div
			className={cn("flex h-10 items-center gap-2 rounded-lg px-2", className)}
