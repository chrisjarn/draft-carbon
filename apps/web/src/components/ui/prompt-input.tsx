...
function PromptInput({
	...
	return (
		<TooltipProvider>
			...
			>
				{/* biome-ignore lint/a11y/useKeyWithClickEvents: wrapper div focuses inner textarea on click */}
				{/* biome-ignore lint/a11y/noStaticElementInteractions: wrapper div focuses inner textarea on click */}
				<div
					onClick={handleClick}
					className={cn(
