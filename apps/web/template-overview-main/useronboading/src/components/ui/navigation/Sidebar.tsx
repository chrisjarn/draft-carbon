				...
				<aside className="flex grow flex-col gap-y-4 overflow-y-auto whitespace-nowrap px-3 py-4">
					<div>
						<div className="flex items-center gap-x-1.5">
							...
							<span
								className={cx(
									"font-semibold text-gray-900 text-sm transition-opacity dark:text-gray-50",
					...
					>
						<div>
							<span
								...
								className={cx(
									"block h-6 font-medium text-gray-500 text-xs leading-6 transition-opacity dark:text-gray-500",
									isCollapsed ? "opacity-0" : "opacity-100",
								)}
							>
								Platform
											...
											>
												<Link
													...
													className={cx(
														...
														"inline-flex items-center rounded-md p-2 font-medium text-sm transition hover:bg-gray-200/50 hover:dark:bg-gray-900",
														focusRing,
													)}
												>
													<item.icon
											...
											<Link
												...
												className={cx(
													isActive(item.href)
														? "text-blue-600 dark:text-blue-500"
														: "text-gray-700 dark:text-gray-300",
													"flex items-center gap-x-2.5 rounded-md p-2 font-medium text-sm transition-opacity hover:bg-gray-200/50 hover:dark:bg-gray-900",
													focusRing,
												)}
											>
												<item.icon
										...
										<Link
											...
											className={cx(
												isActive("/onboarding")
													? "text-blue-600 dark:text-blue-500"
													: "text-gray-700 dark:text-gray-300",
												"flex items-center gap-x-2.5 rounded-md p-2 font-medium text-sm transition hover:bg-gray-200/50 hover:dark:bg-gray-900",
												focusRing,
											)}
										>
					...
					<div className="mt-auto border-gray-200 border-t pt-3 dark:border-gray-800">
						<UserProfileDesktop isCollapsed={isCollapsed} />
					</div>
				</aside>
			</nav>
			{/* top navbar (xs-lg) */}
			<div className="sticky top-0 z-40 flex h-16 shrink-0 items-center justify-between border-gray-200 border-b bg-white px-4 shadow-sm sm:px-6 lg:hidden dark:border-gray-800 dark:bg-gray-950">
				<span
					className={cx(
