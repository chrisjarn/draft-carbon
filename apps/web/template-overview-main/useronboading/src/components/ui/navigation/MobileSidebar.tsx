					...
					<DrawerBody>
						...
						>
							<div>
								<span
									className={cx(
										"block h-6 font-medium text-gray-500 text-xs leading-6 transition-opacity dark:text-gray-400",
									)}
								>
									Platform
								</span>
											...
											<DrawerClose asChild>
												<Link
													...
													className={cx(
														...
														"flex items-center gap-x-2.5 rounded-md px-2 py-1.5 font-medium text-base transition hover:bg-gray-100 sm:text-sm hover:dark:bg-gray-900",
														focusRing,
													)}
												>
													<item.icon
