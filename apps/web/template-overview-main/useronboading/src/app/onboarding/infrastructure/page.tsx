...
export default function PricingCalculator() {
	...
	return (
		<main className="mx-auto p-4">
			...
			>
				<h1 className="font-semibold text-2xl text-gray-900 sm:text-xl dark:text-gray-50">
				...
				<div className="flex flex-col gap-6">
								...
								return (
									<RadioCardItem key={provider} value={provider}>
										<div>
											...
											<p className="mt-1 text-gray-500 text-sm sm:text-xs dark:text-gray-500">
												{
					...
					>
						<div className="space-y-2">
							<Label
								className="whitespace-nowrap font-medium text-base text-gray-900 sm:text-sm/7 dark:text-gray-50"
								htmlFor="storage"
							>
								Storage (GB)
							</Label>
					...
					>
						<Label
							className="font-medium text-base text-gray-900 sm:text-sm dark:text-gray-50"
							htmlFor="region"
						>
							Region
						</Label>
					...
					>
						...
						<div className="flex flex-nowrap gap-4">
							...
							/>
							<div className="flex h-8 w-12 items-center justify-center rounded border border-gray-300 bg-white font-medium text-gray-900 text-sm dark:border-gray-800 dark:bg-gray-950 dark:text-gray-50">
					...
					>
						...
						<p
							className="font-medium text-3xl text-gray-900 sm:text-2xl dark:text-gray-50"
							aria-live="polite"
						>
							{calculatePrice()}
						</p>
