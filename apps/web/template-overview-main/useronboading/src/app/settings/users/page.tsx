					...
					<div className="md:col-span-2">
						...
						<TableRoot className="mt-6" aria-labelledby="users-list-heading">
							<Table className="border-transparent dark:border-transparent">
								<TableHead>
									<TableRow>
										<TableHeaderCell className="w-full font-medium text-xs uppercase">
											Name / Email
										</TableHeaderCell>
										<TableHeaderCell className="font-medium text-xs uppercase">
											Date added
										</TableHeaderCell>
										<TableHeaderCell className="font-medium text-xs uppercase">
											Last active
										...
										<TableRow key={item.name}>
											<TableCell className="w-full">
												{item.status === "pending" ? (
													<div className="flex items-center gap-4">
														<span
															className="inline-flex size-9 items-center justify-center rounded-full border border-gray-300 border-dashed p-1.5 font-medium text-gray-700 text-xs dark:border-gray-700 dark:text-gray-50"
															aria-hidden="true"
														>
															{item.initials}
														</span>
														<div>
															<div className="flex items-center gap-2">
																<div className="font-medium text-gray-900 text-sm dark:text-gray-50">
																	{item.name}
																</div>
																<span className="rounded-md bg-gray-100 px-1.5 py-0.5 font-medium text-gray-600 text-xs dark:bg-gray-400/10 dark:text-gray-300">
																	pending
																</span>
															</div>
													...
													<div className="flex items-center gap-4">
														<span
															className="inline-flex size-9 items-center justify-center rounded-full bg-gray-50 p-1.5 font-medium text-gray-700 text-xs ring-1 ring-gray-300 dark:bg-gray-800 dark:text-gray-50 dark:ring-gray-700"
															aria-hidden="true"
														>
															{item.initials}
														</span>
