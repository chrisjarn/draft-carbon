				...
				<div className="grid grid-cols-1 gap-x-14 gap-y-8 md:grid-cols-3">
					...
					<div className="md:col-span-2">
						<h3
							...
							className="font-semibold text-gray-900 text-sm dark:text-gray-50"
						>
							...
							<Table className="border-transparent dark:border-transparent">
								...
								<TableHead>
									<TableRow>
										...
										<TableHeaderCell className="text-right font-medium text-xs uppercase">
											Quantity
										</TableHeaderCell>
										<TableHeaderCell className="text-right font-medium text-xs uppercase">
											Unit price
				...
				<div className="grid grid-cols-1 gap-x-14 gap-y-8 md:grid-cols-3">
					...
					<div className="md:col-span-2">
						...
						<TableRoot className="mt-4" aria-labelledby="cards-heading">
							<Table>
								<TableHead>
									<TableRow className="border-gray-200 border-b dark:border-gray-800">
										<TableHeaderCell className="font-medium text-xs uppercase">
											Provider
										</TableHeaderCell>
										<TableHeaderCell className="font-medium text-xs uppercase">
