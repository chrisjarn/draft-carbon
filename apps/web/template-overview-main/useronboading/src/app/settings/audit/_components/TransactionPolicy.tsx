		...
		<section aria-labelledby="transaction-policy-heading">
			<div className="grid grid-cols-1 gap-x-14 gap-y-8 md:grid-cols-3">
				<div>
					...
					<p className="mt-2 text-gray-500 text-sm leading-6 dark:text-gray-500">
				...
				<div className="md:col-span-2">
					...
					>
						{blacklist.map((item) => (
							<li key={item.category} className="flex items-start gap-2.5">
								...
								/>
								<div>
									<p className="text-gray-600 text-sm leading-none dark:text-gray-400">
										{item.category}
									</p>
									<p className="mt-1 font-semibold text-gray-900 text-lg dark:text-gray-50">
										{item.description}
									</p>
									...
									<a
										href="#"
										className="mt-2.5 flex items-center gap-0.5 font-normal text-blue-600 text-sm hover:underline hover:underline-offset-4 dark:text-blue-500"
						...
						{keywords.map((item) => (
							...
							>
								...
								<div className="flex items-center gap-2">
									<span className="pr-2 text-gray-600 text-sm dark:text-gray-400">
										{item.flagged}
									</span>
									<span
					...
					>
						...
						>
							<div className="mt-4 flex flex-col items-center gap-2 rounded-md bg-gray-50 p-4 ring-1 ring-gray-200 ring-inset sm:flex-row dark:bg-gray-900 dark:ring-gray-800">
										...
										<SelectContent>
											{keywordCategories.map((item) => (
												<SelectItem key={item.value} value={item.value}>
													...
													<span className="ml-5 font-normal text-gray-700 text-sm dark:text-gray-500">
														{item.description}
													</span>
												</SelectItem>
											))}
