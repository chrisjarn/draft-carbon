	...
	return (
		<div className="flex flex-col gap-2">
			<div className="sticky top-0 z-50 flex items-center gap-2 rounded-md bg-gray-100 px-1 py-1 dark:bg-gray-900">
				...
				/>
				<Label
					className="w-full font-medium text-base sm:text-sm"
		...
		<div>
			...
			<Popover modal={true}>
				...
				>
					...
					>
						Selected Locations
						<span className="flex shrink-0 items-center justify-center rounded bg-gray-200 px-1 text-gray-900 tabular-nums dark:bg-gray-800 dark:text-gray-50">
