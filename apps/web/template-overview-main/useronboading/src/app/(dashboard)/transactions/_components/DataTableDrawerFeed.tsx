			...
			<ul role="list" className="space-y-6">
				{activity.map((activityItem, activityItemindex) => (
					<li key={activityItem.id} className="relative flex gap-x-4">
						...
						>
							<span
								className="w-px bg-gray-200 dark:bg-gray-800"
								aria-hidden="true"
							/>
						</div>
						...
						activityItem.type === "added" ? (
							<>
								...
								<p className="flex-auto py-0.5 text-gray-500 text-xs leading-5 dark:text-gray-500">
							...
							<>
								...
								/>
								<div className="flex-auto rounded-md p-3 ring-1 ring-gray-300 ring-inset dark:ring-gray-800">
									<div className="flex justify-between gap-x-4">
										<div className="py-0.5 text-gray-500 text-xs leading-5 dark:text-gray-500">
											<span className="font-medium text-gray-900 dark:text-gray-50">
												{activityItem.person.name}
											</span>{" "}
											commented
