...
import { expense_statuses, type Transaction } from "@/data/schema";
		...
		>
			...
			<div className="flex items-center space-x-3 truncate">
				...
				<div className="truncate pr-20">
					<p className="truncate font-medium text-gray-900 text-xs hover:underline hover:underline-offset-4 dark:text-gray-50">
						<a href="#">{file.name}</a>
					</p>
					<p className="mt-0.5 text-gray-500 text-xs dark:text-gray-500">
						{file.size} bytes
					</p>
				</div>
			</div>
		...
		<Drawer open={open} onOpenChange={onOpenChange}>
			{datas ? (
				<DrawerContent className="overflow-x-hidden sm:max-w-lg dark:bg-gray-925">
					<DrawerHeader className="w-full -px-6">
						...
						<div className="mt-1 flex items-center justify-between">
							<span className="text-left text-gray-500 text-sm dark:text-gray-500">
								{format(
						...
						<Tabs defaultValue="details">
							...
							<TabsContent value="details" className="space-y-6 px-6">
								<div className="mt-6">
									...
									<div className="relative mt-2 flex h-36 items-center justify-center rounded-lg border border-gray-300 border-dashed dark:border-gray-700">
										<div>
											<File
											...
											<div className="mt-2">
												<label
													htmlFor="file-upload"
													className="cursor-pointer rounded-md text-gray-700 text-sm dark:text-gray-300"
												>
												...
												<span className="pl-1 text-gray-700 text-sm dark:text-gray-300">
									...
									{filesList.length > 0 && (
										<>
											<h4 className="mt-6 font-medium text-gray-900 text-sm dark:text-gray-50">
												File(s) to upload
											</h4>
							...
							<TabsContent value="accounting" className="space-y-6 px-6">
								<h3 className="mt-6 font-medium text-gray-900 text-sm dark:text-gray-50">
									Audit trail
								</h3>
								<DataTableDrawerFeed />
							</TabsContent>
