...
export default function Workflow() {
	...
	const calculateImpact = (stats: typeof displayStats) => {
		...
		const correctionFTE =
			corrected / (COST_ASSUMPTIONS.casesPerFTEAnnually * 2);
			...
			<section className="relative mt-12 overflow-x-scroll p-4">
				{excludedDepartments.size === departments.length ? (
					<div className="absolute inset-0 z-10 bg-white/10 backdrop-blur-sm dark:bg-gray-950/30">
						<div className="flex h-full items-center justify-center">
							<div className="flex flex-col items-center justify-center gap-4 rounded-lg bg-white p-6 shadow-black/5 shadow-xl ring-1 ring-black/5 dark:bg-gray-900">
				...
				<div className="relative grid min-w-[40rem] grid-cols-5">
					<div className="flex flex-col items-center gap-6">
						<h2 className="text-nowrap font-medium text-gray-900 text-sm dark:text-gray-50">
							1. Completed Cases
						</h2>
						<div className="flex justify-center">
							...
							>
								<div className="flex flex-col items-center">
									<span className="mt-1 font-medium text-gray-900 tabular-nums dark:text-gray-50">
										{valueFormatter(displayStats.total_cases)}
									</span>
									<span className="font-medium text-gray-500 text-xs tabular-nums dark:text-gray-500">
										100%
									</span>
								</div>
							</ProgressCircle>
					...
					<div className="mt-24 min-w-32">
						<div className="w-full border-gray-300 border-t border-dashed dark:border-gray-700" />
						<div className="mx-auto h-48 w-px border-gray-300 border-l border-dashed dark:border-gray-700" />
						<div className="ml-auto w-1/2 border-gray-300 border-t border-dashed dark:border-gray-700" />
					</div>
					<div className="flex flex-col items-center gap-6">
						<h2 className="text-nowrap font-medium text-gray-900 text-sm dark:text-gray-50">
							2. Test Results
						...
						<div>
							<div className="flex justify-center">
								...
								>
									<div className="flex flex-col items-center">
										...
										<span className="font-medium text-gray-500 text-xs tabular-nums">
											{calculatePercentage(
												displayStats.tested_cases,
												displayStats.total_cases,
											).toFixed(1)}
							...
							<p className="mt-4 text-gray-700 text-sm dark:text-gray-300">
								Tested Cases
							</p>
						</div>
						<div className="mt-10">
			...
			<section className="relative mt-12">
				...
				<div className="mt-4 grid grid-cols-1 gap-6 sm:grid-cols-2 lg:grid-cols-3">
					<div className="relative rounded-md border border-gray-200 bg-white px-4 py-3 shadow-sm dark:border-gray-800 dark:bg-gray-900">
						...
						<div>
							...
							<p className="flex items-center justify-between gap-2">
								<span className="font-medium text-gray-900 text-lg dark:text-gray-50">
									{valueFormatter(displayStats.total_cases)}
								</span>
								<span className="font-medium text-base text-gray-500 dark:text-gray-500">
				...
				<div className="mt-8 grid grid-cols-1 gap-8 sm:grid-cols-2">
					<div>
						...
						>
							{[1, 5, 10].map((years) => {
								const baseMultiplier = GROWTH_FACTORS.SAVINGS_BASE ** years;
								const acceleratedGrowth =
									GROWTH_FACTORS.SAVINGS_ACCELERATION ** years;
								...
								return (
									...
									>
										...
										<span className="flex items-center gap-3 tabular-nums">
											...
											/>
											<span
												className={`rounded px-1.5 py-1 text-right font-semibold text-xs ${
													difference === 0
					...
					<div>
						...
						>
							{[1, 5, 10].map((years) => {
								const baseMultiplier = GROWTH_FACTORS.FTE_BASE ** years;
								const acceleratedGrowth =
									GROWTH_FACTORS.FTE_ACCELERATION ** years;
								const totalMultiplier =
									baseMultiplier * acceleratedGrowth * (1 + years * 0.1);
