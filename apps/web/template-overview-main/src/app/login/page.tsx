	...
	return (
		<div className="flex min-h-screen flex-col items-center justify-center px-4 py-28 lg:px-6">
			<div className="relative sm:mx-auto sm:w-full sm:max-w-sm">
				...
				<div className="relative mx-auto w-fit rounded-xl bg-gray-50 p-4 shadow-black/10 shadow-md ring-1 ring-black/10 dark:bg-gray-900 dark:ring-gray-800">
					...
					<div className="w-fit rounded-lg bg-gradient-to-b from-blue-400 to-blue-600 p-3 shadow-blue-500/50 shadow-sm ring-1 ring-white/25 ring-inset">
						<RiContrast2Line className="size-8 text-white" aria-hidden="true" />
					</div>
				</div>
				<h2 className="mt-4 text-center font-semibold text-gray-900 text-xl dark:text-gray-50">
					Sign in to Overview
				</h2>
				<div className="mt-10">
