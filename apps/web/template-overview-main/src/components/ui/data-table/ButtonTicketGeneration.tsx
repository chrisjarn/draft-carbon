	...
	({ initalState, className, ...props }: ButtonProps, forwardedRef) => {
		...
		return (
			<button
				...
				className={cx(
					// base
					"relative inline-flex items-center justify-center gap-1.5 whitespace-nowrap rounded-md border px-2 py-1 text-center font-medium text-sm shadow-sm transition-all duration-100 ease-in-out",
					// disabled
