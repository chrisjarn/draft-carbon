...
export const columns = [
			...
			return (
				<div className="flex flex-col gap-1">
					...
					<div className="flex items-center gap-1 text-xs">
						...
						<span className="font-medium font-mono text-gray-900 uppercase tabular-nums dark:text-gray-50">
	...
	columnHelper.accessor("end_date", {
		...
		cell: ({ row }) => {
			return (
				<div className="flex flex-col gap-1">
					<span className="text-gray-900 tabular-nums dark:text-gray-50">
					...
					<span className="text-gray-500 text-xs tabular-nums dark:text-gray-500">
						Start:{" "}
	...
	columnHelper.accessor("minutes_called", {
		...
		cell: ({ row }) => {
			...
			const getColorByCapacity = (value: number) => {
				const fixedValue = Number.parseFloat(value.toFixed(0));
