	...
	<>
		<DrawerHeader>
			<DrawerTitle>
				...
				<span className="font-normal text-gray-500 text-sm dark:text-gray-500">
					Ticket Type & Category
				</span>
			</DrawerTitle>
		</DrawerHeader>
		<DrawerBody className="-mx-6 space-y-6 overflow-y-scroll border-gray-200 border-t px-6 dark:border-gray-800">
...
const SummaryPage = ({ formData }: { formData: TicketFormData }) => (
	<>
		...
		<DrawerBody className="-mx-6 space-y-4 overflow-y-scroll border-gray-200 border-t px-6 dark:border-gray-800">
