import type { WorkflowStats } from "./schema";

export const workflowStats: WorkflowStats[] = [
	{
		id: "d7b3511a-9308-44f7-ac97-b634674a0fcf",
		total_cases: 11723,
		department_stats: [
			{
