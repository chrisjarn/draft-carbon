...
const HIRING_NEEDS = [
	...
	},
	{
		...
		salary_min: 75000,
		salary_max: 95000,
		target_start: "2025-09-01",
		approved_by: "Anthony McPhee",
	...
	},
	{
		...
		approved_by: "Wellington Takakura",
...
async function seed() {
	...
	if (Number.parseInt(existing.n) > 0) {
		console.log(
			`⚠️  Database already has ${existing.n} carbonites. Skipping seed.`,
		);
		console.log(
			"   Run: node scripts/migrate.js --reset  to wipe and re-seed.",
		);
		process.exit(0);
	}
